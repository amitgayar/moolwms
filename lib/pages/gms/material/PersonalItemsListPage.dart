...
//
//   PersonalItemsListPage(dynamic args) {
//     if (args is Map) {
...
//
//   @override
//   _PersonalItemsListPageState createState() => _PersonalItemsListPageState();
// }
//
// class _PersonalItemsListPageState extends State<PersonalItemsListPage> {
//   List<PersonalMaterialItemModel> itemsList = <PersonalMaterialItemModel>[];
//
//   @override
//   void initState() {
//     super.initState();
//     if (widget.materialModel != null) {
//       if (widget.materialModel?.personalMaterials?.isNotEmpty ?? false) {
//         itemsList = widget.materialModel.personalMaterials;
//       }
//     }
//   }
//
...
//       appBar: AppBar(
//           title:
//               Text(AppLocalizations.of(context).translate("personal_items"))),
...
//                     '/admin/gms/material/personal_item/items/add',
//                     arguments: {"item": e}).then((value) {
//                   if (value != null && value is PersonalMaterialItemModel) {
//                     setState(() {
//                       e = value;
//                     });
//                   }
...
//               //   widget.materialModel.personalMaterials = itemsList;
