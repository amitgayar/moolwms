...
class AssetsItemAddPage extends StatefulWidget {
  ...
  AssetsItemAddPage(dynamic args) {
    if (args is Map) {
      item = args['item'];
    }
  }
  ...
  @override
  _AssetsItemAddPageState createState() => _AssetsItemAddPageState();
}

class _AssetsItemAddPageState extends State<AssetsItemAddPage> {
