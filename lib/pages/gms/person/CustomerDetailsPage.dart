...
class CustomerDetailsPage extends StatefulWidget {
  ...
  CustomerDetailsPage(dynamic args) {
    if (args is Map) {
                    ...
                    if (personModel != null) {
                      ...
                      bool tpOtp = await widget.personStore
                          .sendThirdPersonAuthOTP(context, personModel.fullName,
                              ...
                              customer: personModel.customer);
                      if (tpOtp != null && tpOtp) {
                        Navigator.of(context)
                            .pushNamed("/verifyotp", arguments: {
                          "personName":
                              personModel.customer.authenticatedVisitor.name,
                          "mobileNo": personModel
                              .customer.authenticatedVisitor.mobileNo,
                          "isPerson": true,
                          "isOtpSent": true,
                          "otpType": 2,
