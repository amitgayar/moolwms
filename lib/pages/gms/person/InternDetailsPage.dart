...
class InternDetailsPage extends StatefulWidget {
  PersonModel personModel;
  PersonStore personStore;
  InternDetailsPage(dynamic args) {
    if (args is Map) {
  ...
  @override
  _InternDetailsPageState createState() => _InternDetailsPageState();
}

class _InternDetailsPageState extends State<InternDetailsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(AppLocalizations.of(context).translate("intern_details")),
      ),
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  TextFormField(
                    initialValue: personModel.internCode,
                    onSaved: (val) => personModel.internCode = val,
                    validator: (val) {
                      if (val.isEmpty) {
                        return AppLocalizations.of(context)
                            .translate("enter_intern_code");
                      }
                      return null;
                    },
                    decoration: DecorationUtils.getTextFieldDecoration(
                      context,
                      labelText:
                          AppLocalizations.of(context).translate("intern_code"),
                    ),
                  ),
